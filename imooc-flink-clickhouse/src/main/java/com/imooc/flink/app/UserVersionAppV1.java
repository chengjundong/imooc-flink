...
/**
 * Analyze user behavior by version
 *
 * @author jared
 * @version 1
 * @since 2022/1/3
 */
public class UserVersionAppV1 {

    private static final Logger LOG = LoggerFactory.getLogger(UserVersionAppV1.class);
    ...
    public static void main(String[] args) throws Exception {
        ...
        dataAfterClean.map(new MapFunction<Access, Tuple3<String, Integer, Long>>() {
                    ...
                    public Tuple3<String, Integer, Long> map(Access access) throws Exception {
                        return Tuple3.of(access.getVersion(), access.getNu(), 1L);
                    }
                })
